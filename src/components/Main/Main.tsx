...
const Main = () => {
  return (
    <div className="container mx-auto flex flex-wrap min-h-[800px]">
      <aside className="px-5 pt-8 min-w-[300px]">
        {days.map((day: string[], index: number) => {
          return (
            <Accordion type="single" collapsible>
              ...
              >
                <AccordionTrigger className="px-1 hover:pl-3 mb-1 rounded-lg hover:bg-muted hover:text-violet-600 hover:no-underline  transition-[padding] duration-150 font-semibold">{`C0${index}`}</AccordionTrigger>
      ...
      {/* main */}
      <main className="flex gap-4 flex-col flex-1">
        {/* Landing */}
        <Landing />

        <div className="h-[542px] flex-1 flex flex-row gap-4">
          {/* Start Input */}
